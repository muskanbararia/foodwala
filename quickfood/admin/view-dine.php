                      ...
                      <h4><i class="fa fa-angle-right"></i>Dine In</h4>
                            ...
                            <table class="table table-bordered table-striped table-condensed" id="rest" >
                              ...
                              <?php  
                                ...
                                $view_users_query="select * from dineIn";//select query for viewing users.  
                                ...
                                {  
                                    ...
                                    $address2=$row[5];
                                    $inq3 = "SELECT * FROM user WHERE id='$address2'";
                                        $query3 = mysqli_query($dbcon,$inq3);
                              ...
                              ?>  
                                 ...
                                 <td><form method ="post" action="view.php" >
                                  ...
                                  <input type="submit" name="d_del" value="Delete"></form></td>
                              </tr>
                              <? }
                                }
